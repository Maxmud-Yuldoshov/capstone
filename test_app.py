...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_post_movies(self):
        res = self.client().get(
            '/movies', json=new_movie, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_post_movies_invalid(self):
        ...
        res = self.client().post(
            '/movies', json=new_movie_error, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_search_movie(self):
        ...
        res = self.client().post(
            '/movies/search', json=search_item, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_search_movie_invalid(self):
        ...
        res = self.client().post(
            '/movies/search', json=new_search, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_patch_movie(self):
        ...
        res = self.client().patch(
            '/movies/4', json=patch_title, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_post_actors(self):
        res = self.client().get(
            '/actors', json=new_actor, headers=self.director
        )
        data = json.loads(res.data)
        ...
        self.assertEqual(data['message'],
                         'The Actor is successfully created')
    ...
    def test_post_actors_invalid(self):
        ...
        res = self.client().post(
            '/actors', json=new_actor_error, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_search_actor(self):
        search_item = {'searchTerm': 'a'}
        res = self.client().post(
            '/actors/search', json=search_item, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_search_actor_invalid(self):
        new_search = {'searchTerm': ''}
        res = self.client().post(
            '/actors/search', json=new_search, headers=self.producer
        )
        data = json.loads(res.data)
    ...
    def test_patch_actor(self):
        ...
        res = self.client().patch(
            '/actors/1', json=patch_title, headers=self.producer
        )
        data = json.loads(res.data)
